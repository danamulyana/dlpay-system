...
<div class="top-bar">
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false">
            <img alt="{{ Auth::user()->username }}" src="{{ Auth::user()->profile_photo_path ? asset('dist/images/') : asset('dist/images/200x200.jpg') }}">
        </div>
        <div class="dropdown-menu w-56">
            <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                ...
                <div class="p-2">
                    <a href="{{ route('ProfileInformation') }}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
