<div>
    <h2 class="intro-y text-lg font-medium mt-10">Data Departement</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            <button class="btn btn-primary shadow-md mr-2" wire:click="showmodal">Add Departement</button>
            @endcan
            <div></div>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        @if(auth()->user()->can('departement_edit') || auth()->user()->can('departement_delete'))
    ...
    <x-jet-dialog-modal wire:model="confirmingAddModal">
        ...
        <x-slot name="content">
            <div class="my-4">
                <x-jet-label for="nama" value="{{ __('Nama Departement') }}" />
                <x-jet-input type="nama" class="mt-1 block w-3/4"
                                placeholder="{{ __('Nama Departement') }}"
                                x-ref="nama"
