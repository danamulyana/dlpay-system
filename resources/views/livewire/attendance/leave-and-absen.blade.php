            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr >
                        ...
                        @if(auth()->user()->can('LeaveAndAbsence_edit') || auth()->user()->can('LeaveAndAbsence_delete'))
